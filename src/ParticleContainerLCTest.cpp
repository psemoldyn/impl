...
void ParticleContainerLCTest::setUp(){
	...
	ParticleContainer2x2 = new ParticleContainerLC(4.5, domain2);
	double x[3] = {0,0,0};
	double v[3] = {0,0,0};
	Particle p1(x,v,1);
	double x2[3] = {50,0,0};
	...
	this->p3 = p3;
	this->p4 = p4;
	ParticleContainer3x3x3 = new ParticleContainerLC(3.0,domain3);
...
//	((ParticleContainer) ParticleContainer2x2).add(p1);
	...
	ParticleGeneratorCuboid pg(&ParticleContainer2x2->getParticles(), fp1, 1, 1, 1, 0, 1, fp1 ,1,1,0);
